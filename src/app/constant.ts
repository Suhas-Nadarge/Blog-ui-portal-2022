...
export const mockData = {
    "posts": [{
      ...
      "id": 4,
      "title":"Blog post #4",
      "author": "Magnolia Moyer",
      "publish_date": "2016-06-03",
      "slug": "blog-post-4",
      "description": "Has omnes vivendum invenire ne, est facete everti erroribus et.",
      "content": "<p>Has omnes vivendum invenire ne, est facete everti erroribus et. Sit eu partem deserunt, molestiae forensibus theophrastus vel ex, quod sensibus constituam ad vim.</p> <p>Eruditi indoctum repudiare sit ex, modo duis oratio nam ei. Ea ius laoreet nominati dissentias.</p>"
    }, {
      "id": 5,
      "title":"Blog post #5",
      ...
      "slug": "blog-post-5",
      "description": "Eum no quem novum periculis, mea sonet zril ea.",
      ...
      "content": "<p>Velit doming vis te, ut vim fugit abhorreant. Eirmod reformidans duo at, ne nam virtute commune, sit cu esse vidit zril.</p> <p>Iusto officiis eloquentiam cum ea, eu case interpretaris duo. Duis ancillae an pro, vel idque error alienum at. An nec graeco equidem, unum eripuit ea sit.</p>"
    }, {
      "id": 7,
      "title":"Blog post #7",
      ...
      "content": "<p>Diceret appetere pro ne, corpora neglegentur per at. Mea solum nonumes te, id posse admodum has. Sonet tantas at per, vix te hinc vidit.</p> <p>Brute civibus no sed. Vel et laoreet mediocritatem. In eos doming labores.</p>"
    }, {
      "id": 8,
      "title":"Blog post #8",
